...
func getChannelSize(chunkSize int) int {
	var overhead uint64 = 10000000                 // 10 MB estimate
	var subprocess uint64 = uint64(chunkSize * 90) // 4-8 bytes per int + actual bytes, 4 stored; overhead per subprocess estimate
